...
|  cores | number | _(Optional)_ Amount of Cores of the purchased server. Must be a positive Integer. Maximum value of 6. Defaults to the current amount of cores |
