...
|  [ownedSF](./bitburner.resetinfo.ownedsf.md) |  | Map&lt;number, number&gt; | A map of owned source files. Its keys are the SF numbers. Its values are the active SF levels. This map takes BitNode options into account. For example, let's say you have SF 1.3, but you overrode the active level of SF1 and set it to level 0. In this case, this map contains this entry: Key: 1 =<!-- -->&gt; Value: 0. |
