...
case $BUILD_PLATFORM in
  ...
  "linux")
    electron-packager .package bitburner --platform linux --arch x64,arm64 --out .build --overwrite --icon .package/icon --app-copyright "Copyright (C) 2025 Bitburner";;
  "mac")
    electron-packager .package bitburner --platform darwin --arch universal --out .build --overwrite --icon .package/icon.icns --app-copyright "Copyright (C) 2025 Bitburner";;
  *)
    electron-packager .package bitburner --platform win32 --arch x64,arm64 --out .build --overwrite --icon .package/icon.ico --app-copyright "Copyright (C) 2025 Bitburner";
    electron-packager .package bitburner --platform linux --arch x64,arm64 --out .build --overwrite --icon .package/icon --app-copyright "Copyright (C) 2025 Bitburner";
    electron-packager .package bitburner --platform darwin --arch universal --out .build --overwrite --icon .package/icon.icns --app-copyright "Copyright (C) 2025 Bitburner";;
