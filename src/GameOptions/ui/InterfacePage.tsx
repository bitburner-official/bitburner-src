  ...
  return (
    <GameOptionsPage title="Interface">
      ...
      <OptionSwitch
        ...
        text={<>Enable VFX <span style={{display: "inline", color: Settings.theme.warning}}>(VISUAL EPILEPSY WARNING!)</span></>}
        tooltip={<>If this is set all visual effects will be enabled.<br/><span style={{color: Settings.theme.warning}}>WARNING: DISABLE THIS IF YOU HAVE VISUAL EPILEPSY</span></>}
      />
      <OptionSwitch
