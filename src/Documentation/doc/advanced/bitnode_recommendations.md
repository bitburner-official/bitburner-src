...
BN-1 is the introductory [BitNode](../advanced/bitnodes.md) with no difficulty modifiers to slow you down.
Its [Source-File](../advanced/sourcefiles.md) is extremely powerful as it raises all multipliers by a significant amount.
There are no other [BitNodes](../advanced/bitnodes.md) which significantly simplify this one or make it particularly easier, so BN-1.2 and BN-1.3 are natural first choices.

BN-2 is the home of the [Gang](../advanced/gang.md) mechanic.
...
BN-3 makes available the [Corporation](../advanced/corporations.md) mechanic.
