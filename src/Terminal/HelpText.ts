export const TerminalHelpText: string[] = [
  ...
  "    import [dir]                     Import scripts and text files from a zip file into the game",
...
export const HelpTexts: Record<string, string[]> = {
  ...
  import: [
    "Usage: import [dir]",
    " ",
    "Asks you to open a zip file and unpacks it into a directory.",
    "Creates the directory if it does not already exist. Overwrites exising files.",
    " ",
    "Examples:",
    " ",
    "    import path/to/dir",
