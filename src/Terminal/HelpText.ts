export const TerminalHelpText: string[] = [
  ...
  "    cat [-t] [file]                       Display the contents of a file",
...
export const HelpTexts: Record<string, string[]> = {
  ...
  cat: [
    "Usage: cat [-t] [filename]",
    " ",
    "Display message (.msg), literature (.lit), script (.js, .jsx, .ts, .tsx), or text (.txt, .json, .css) files.",
    " ",
    "If this command is ran with the '-t' flag the contents will be dumped in the terminal instead of in a dialog box. ",
    "Note that it doesn't work for .lit or .msg files. Examples:",
    " ",
    "    cat j1.msg",
    " ",
    "    cat foo.lit",
