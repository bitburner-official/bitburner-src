export const TerminalHelpText: string[] = [
  ...
  "    download FILE                    Download FILE to your real-world computer",
  ...
  "    home                             Connect to your home server",
  ...
  "    run FILE [-t THREADS] [--tail]   Run a program, script, or coding contract",
  "        [--ram-override GB]",
  "        [--temporary] [ARGS...]",
  "    scan                             Print servers connected to this server",
