export const TerminalHelpText: string[] = [
  ...
  "- ... means you can pass in multiple arguments separated by spaces. For example, scp FILE... DESTINATION_SERVER lets you add multiple files.",
  " ",
  ...
  "    scp FILE... DESTINATION_SERVER   Copy scripts, text files, or .lit files to a destination server",
...
export const HelpTexts: Record<string, string[]> = {
  ...
  download: [
    "Usage: download FILE",
    " ",
    "Download a script or text file to your real-life computer.",
    " ",
  ...
  free: [
    "Usage: free",
    " ",
    "Display the memory usage on the current machine. Print the amount of RAM that is available on the current server as well as ",
  ...
  scp: [
    "Usage: scp FILE... DESTINATION_HOSTNAME",
    " ",
  ...
  unalias: [
    ...
    " ",
    "Delete the specified alias. Note that the double quotation marks are required. ",
    " ",
