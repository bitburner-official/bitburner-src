export const TerminalHelpText: string[] = [
  ...
  "    export [script/text file]        Exports scripts or text files from the game",
...
export const HelpTexts: Record<string, string[]> = {
  ...
  export: [
    "Usage: export [script/text file]",
    " ",
    "Exports a script or text file from the game to your computer (like your real life computer).",
    " ",
    "This command only exports files. If you want to export the whole saved game, click the Export Game button on the Options page in the main navigation menu.",
    " ",
    "You can also export all of your scripts/text files as a zip file using the following Terminal commands:",
    " ",
    "Export all scripts and text files: export *",
    " ",
    "Export all JS scripts: export *.js",
    " ",
    "Export all text files: export *.txt",
    " ",
  ],
  expr: [
