export const TerminalHelpText: string[] = [
  ...
  " ",
  "In the below:",
  "- Square brackets [] mean something's optional. No brackets means it's mandatory. Curly brackets {} mean",
  "     there's a choice of mandatory arguments.",
  "- Upper case means something's a placeholder and you need to choose a value.",
  "- ... means you can pass in any number of items separated by spaces. For example, scp FILE... SERVER lets you",
  "     add multiple files.",
  " ",
  ...
  "    download FILE                    Download scripts or text files to your computer",
  "    upload DIRECTORY                 Upload scripts or text files from your computer",
  ...
  "    kill {SCRIPT [ARGS...]|PID}      Stop the specified script on the current server ",
  ...
  "    nano {FILE|GLOB}...              Open script or text files in the Script Editor",
  ...
  "    tail {SCRIPT [ARGS...]|PID}      Display dynamic logs for the specified script",
  "    top                              Display all running scripts and their RAM usage",
  "    unalias {ALIAS_NAME|--all}       Delete the specified alias",
  "    vim {FILE|GLOB}...               Open script or text files in the Script Editor in Vim mode",
...
export const HelpTexts: Record<string, string[]> = {
  ...
  grep: [
    "Usage: grep [OPTION]... PATTERN [FILE]... [-O OUTFILE] [-m NUM] [-B NUM] [-A NUM] [-C NUM]",
    " ",
  ...
  tail: [
    ...
    "arguments that were used to run it. So, if a script was ran with the following arguments: ",
    " ",
    "    run foo.js 10 50000",
    " ",
