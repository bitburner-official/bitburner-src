export const TerminalHelpText: string[] = [
  ...
  "    check SCRIPT [ARGS...]           Print a script's logs",
  "    clear                            Clear the Terminal",
  "    cls                              Clear the Terminal",
  "    connect HOSTNAME                 Connect to server HOSTNAME",
  "    cp SOURCE DESTINATION            Copy SOURCE to DESTINATION",
  "    download {FILE|PATTERN}          Download files to your real-world computer",
  "    upload DIR                       Upload DIR from your real-world computer",
  ...
  "    hostname                         Print the hostname of this server",
  ...
  "    nano {FILE|PATTERN}...           Open files in the Script Editor",
  "    ps [-g PATTERN]                  List all running scripts, optionally filtered by PATTERN",
  "    rm [OPTION...] FILE...           Delete files from this server",
  "    run FILE [-t NUM] [--tail]       Run a program, script, or coding contract",
  "        [--ram-override GB]",
  "        [--temporary] [ARGS...]",
  "    scan                             Print servers 1 node away",
  "    scan-analyze [DEPTH] [-a]        Print servers up to DEPTH nodes away; -a includes purchased servers",
  ...
  "    vim {FILE|PATTERN}...            Open files in the Script Editor in Vim mode",
...
const TemplatedHelpTexts: Record<string, (command: string) => string[]> = {
  scriptEditor: (command) => {
    return [
      ...
      `one will be created.`,
      ` `,
      `Any argument containing '*' or '?' is treated as a pattern and matched against existing files on the `,
      `server. All matches are then opened. ${command} cannot create files via a pattern, so a file matched by `,
      `one must already exist.`,
      ` `,
      `Pattern and literal filename arguments can be freely mixed in the same command. `,
      ` `,
      `Examples:`,
      ` `,
      `    ${command} test.js`,
...
export const HelpTexts: Record<string, string[]> = {
  ...
  download: [
    "Usage: download {FILE|PATTERN}",
    " ",
    "Download a script or text file to your real-life computer.",
    " ",
    "You can also download a group of files as a zip file using a PATTERN.",
    " ",
  ...
  sudov: ["Usage: sudov", " ", "Prints whether or not you have root access to the current server", " "],
