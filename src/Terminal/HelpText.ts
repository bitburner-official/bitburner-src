export const TerminalHelpText: string[] = [
  ...
  "- ... means you can pass in multiple arguments separated by spaces. For example, scp FILE... SERVER_HOSTNAME lets you add multiple files.",
  " ",
  ...
  "    scp FILE... SERVER_HOSTNAME      Copy scripts, text files, or .lit files to a destination server",
...
export const HelpTexts: Record<string, string[]> = {
  ...
  scp: [
    "Usage: scp FILE... SERVER_HOSTNAME",
    " ",
