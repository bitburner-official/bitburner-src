...
export const HelpTexts: Record<string, string[]> = {
  ...
  grep: [
    "Usage: grep [OPTION]... PATTERN [FILE]... [-O] [OUTPUT FILE]",
    " ",
    "Search for PATTERN in each FILE and print results to terminal.",
    "Example: grep -n -h 'hello world' file1.js file2.txt -O output.txt",
    " ",
    "Search control:",
    "  -* --search-all        search for PATTERN in each FILE on server. Ignores FILE argument(s) passed ",
    " ",
    "Pattern selection and interpretation:",
    "  -G, --basic-regexp     PATTERN is basic regular expression. PATTERN is a string by default",
    " ",
    "Output control:",
    "  -H --with-filename     print file name with output lines. Default when multiple FILE arguments passed",
    "  -h --no-filename       do not print file name with output lines. Default when one FILE argument passed. Overrides -H",
    "  -n --line-number       print line number with output lines",
    "  -q --quiet --silent    suppress printing to terminal",
    "  -O --output [file]     pipe output to text file. The following argument must be a valid .txt or .json filename. Does NOT overwrite by default",
