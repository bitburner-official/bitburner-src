export const TerminalHelpText: string[] = [
  ...
  "- Upper case means something's a placeholder and you need to choose a value.",
  "- ... means you can pass in multiple arguments separated by spaces. For example, scp FILE... SERVER lets you add multiple files.",
  " ",
  ...
  "    changelog                        Display Bitburner's changelog",
  "    check SCRIPT [ARGS...]           Print a script's logs to the Terminal",
  ...
  "    upload DIR                       Upload scripts or text files from your IRL computer",
  "    expr EXPRESSION                  Evaluate a mathematical expression",
  "    free                             Check the machine's memory (RAM) usage",
  "    grep [OPTION]... PATTERN         Search for a PATTERN (string/regular expression) in each FILE and print the results to the Terminal",
  "         [FILE]... [-O OUTFILE]",
  "         [-{m|A|B|C} NUM]...",
  ...
  "    kill {PID|SCRIPT [ARGS...]}      Stop the specified script on the current server",
  "    killall                          Stop all running scripts on the current machine",
  "    ls [DIR] [-l] [-h] [-g PATTERN]  Display all files on the machine",
  "    lscpu                            Display the number of CPU cores on the machine",
  "    mem SCRIPT [-t NUM_THREADS]      Display the amount of RAM required to run the script",
  "    mv SOURCE DESTINATION            Move/rename a text or script file",
  "    nano {FILE|GLOB}...              Open a script or text file in the Script Editor",
  "    ps [-g, --grep PATTERN]          Display all scripts that are currently running",
  "    rm [OPTION]... FILE...           Delete a file from the server",
  "    run FILE [-t N] [--tail]         Run a program, a script, or a coding contract",
  "        [--ram-override GB]",
  "        [--temporary] [ARGS...]",
  ...
  "    wget URL TARGET_FILE             Retrieve code/text from an IRL web server",
  " ",
  " ",
  "NETWORK NAVIGATION",
  " ",
  ...
  "    home                             Connect to home computer",
  "    scan                             Print all immediately-available network connections",
  "    scan-analyze [DEPTH] [-a]        Print info for all servers up to the specified depth of nodes away",
  " ",
  "GENERAL SERVER INTERACTIONS",
  " ",
  "    analyze                          Display information about the current machine",
  "    backdoor                         Install a backdoor on the current machine",
  "    free                             Check the machine's memory (RAM) usage",
  "    grow                             Spoof money in a server's bank account, increasing the amount available",
  "    hack                             Hack the current machine",
  ...
  "    ipaddr                           Display the IP address of the machine",
  "    lscpu                            Display the number of CPU cores on the machine",
  "    sudov                            Display whether you have root access on this computer",
  "    weaken                           Reduce the security of the current machine",
  " ",
  "FILES",
  " ",
  ...
  "    kill {PID|SCRIPT [ARGS...]}      Stop the specified script on the current server",
  "    killall                          Stop all running scripts on the current machine",
  "    mem SCRIPT                       Display the amount of RAM required to run the script",
  "        [-t NUM_THREADS]",
  "    run FILE [-t N] [--tail]         Run a program, a script, or a coding contract",
  "        [--ram-override GB]",
  "        [--temporary] [ARGS...]",
  ...
  "THE TERMINAL",
  " ",
  '    alias [-g] [ALIAS_NAME="VALUE"]  Create or display aliases (shortcuts for Terminal commands)',
  "    unalias {ALIAS_NAME|--all}       Delete the specified alias",
  "    clear                            Clear all text on the Terminal",
  "    cls                              Clear all text on the Terminal",
  "    help [COMMAND]                   Display this help text, or the help text for a specific command",
...
const TemplatedHelpTexts: Record<string, (command: string) => string[]> = {
  scriptEditor: (command) => {
    return [
      ...
      ` `,
      `Opens up the specified files in the Script Editor. Only scripts (.js, .jsx, .ts, .tsx) `,
      ...
      `server. All matches are then opened. ${command} cannot create files via a glob, so a file matched by `,
...
export const HelpTexts: Record<string, string[]> = {
  ...
  grep: [
    ...
    " ",
    "Search for PATTERN in each FILE and print results to the Terminal.",
    ...
    " ",
    "Search control:",
    "  -* --search-all          search for PATTERN in each FILE on server. Ignores any FILE arguments passed",
    "  -p --pipe-terminal       search for PATTERN in Terminal output. Ignores any FILE arguments passed",
    " ",
    ...
    "  -q --quiet --silent      suppress printing to the Terminal",
    ...
    " ",
    "Miscellaneous:",
    "  -V --verbose             print PATTERN, count of matches and FILEs searched after regular output",
  ...
  run: [
    ...
    "save data. You must specify FILE after 'run' and before any flags. You can use the built-in flags or mix them",
  ...
  scp: [
    "Usage: scp FILE... SERVER",
    " ",
    "Copies the specified files from the current server to the target server. ",
  ...
  tail: [
    ...
    " ",
    "Displays dynamic logs for the script specified by the script name and arguments, or by its PID. Each argument ",
    ...
    " ",
    "Alternatively, if you know the script's PID, you can tail it directly: ",
    " ",
    "    tail 15",
    " ",
  ],
