...
export class Remote {
  ...
  public startConnection(): void {
    ...
    this.connection.addEventListener("error", (e: Event) =>
      SnackbarEvents.emit(`Error with websocket ${address}, details: ${JSON.stringify(e)}`, ToastVariants.ERROR, 5000),
    );
    ...
    this.connection.addEventListener("close", () =>
      SnackbarEvents.emit("Remote API connection closed", ToastVariants.WARNING, 2000),
    );
  }
}
