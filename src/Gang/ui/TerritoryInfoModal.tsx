    ...
    <Modal open={open} onClose={onClose}>
      <>
        ...
        <Typography>
          ...
          your gang's power, which can be found in the Territory display or with methods from the Gang API. Your gang's
          power slowly accumulates over time. The accumulation rate is determined by the stats of all Gang members you
          have assigned to the 'Territory Warfare' task. Gang members that are not assigned to this task do not
          contribute to your gang's power. Your gang also loses a small amount of power whenever you lose a clash.
          <br />
          <br />
