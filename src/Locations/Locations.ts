...
Cities[CityNames.Aevum].asciiArt = `
...
[galactic cybersystems]  G               35 x
                      ...
                      67 o
                                    ...
                                    [the slums] P                               `;
Cities[CityNames.Chongqing].asciiArt = `
                                    |
                                 75 o
                                     \\
                                      o 76
...
[solaris space system] B            |
                    ...
                    34 o            E [travel agency]
                                    ...
                                    x 82
             [the slums] D                                                      `;
Cities[CityNames.Ishima].asciiArt = `
                                          o 59
                  o        o              |
 [storm tech.]    |        |              G [world stock exchange]
   ...
   48 o     /                      55 x       \\ /
    ...
    o      50                  52
              [omega soft.]
                                       [the slums] E                            `;
Cities[CityNames.NewTokyo].asciiArt = `
             ...
             [vitalife]              o 12   [global pharmaceuticals]
               ...
               o--D-x----x-------x-C-+--------x--x-B-x---x-o
                  ...
                  o--x--F--x-----x-----x---+---x----x--I--x-o
                                           ...
                                           G  [the slums]
                                                                                `;
Cities[CityNames.Sector12].asciiArt = `
          78                                                     o 97
...
Cities[CityNames.Volhaven].asciiArt = `
                                 [omnia cybersystems]
                   17         66               68
                  o            o------G-------o
                   \\          /                \\
