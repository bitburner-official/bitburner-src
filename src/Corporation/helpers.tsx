...
export function calculateMaxAffordableUpgrade(corporation: Corporation, upgrade: CorporationUpgrade, amount: number|"MAX"): number{
    if (amount != "MAX"){
    ...
    let n = 1;
    while(calculateUpgradeCost(corporation,upgrade, n*2) < corporation.funds && (amount != "MAX" ? n<amount:true)){
        n *= 2;
    } 
